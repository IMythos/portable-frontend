            ...
            >
                <div className="w-full pl-6 pr-6">
                    ...
                    <nav className="w-full mt-12">
                        ...
                        <li className="flex items-center list-none pt-3 pb-3 pl-4 pr-4 mb-3 text-gray-500 hover:text-gray-700 hover:bg-indigo-100 hover:cursor-pointer rounded-lg" onClick={() => routeHandler("/dashboard")}>
                            <HomeIcon className="size-6" />
                            <a className="ml-3">Home</a>
                        </li>
                        <li className="flex items-center list-none pt-3 pb-3 pl-4 pr-4 mb-3 text-gray-500 hover:text-gray-700 hover:bg-indigo-100 hover:cursor-pointer rounded-lg" onClick={() => routeHandler("/dashboard/sales")}>
                            <ShoppingCartIcon className="size-6" />
                            <a className="ml-3">Ventas</a>
                        </li>
                        <li className="flex items-center list-none pt-3 pb-3 pl-4 pr-4 mb-3 text-gray-500 hover:text-gray-700 hover:bg-indigo-100 hover:cursor-pointer rounded-lg" onClick={() => routeHandler("/dashboard/purchases")}>
                            <DocumentCurrencyDollarIcon className="size-6" />
                            <a className="ml-3">Compras</a>
                        </li>
                        <li className="flex items-center list-none pt-3 pb-3 pl-4 pr-4 mb-3 text-gray-500 hover:text-gray-700 hover:bg-indigo-100 hover:cursor-pointer rounded-lg" onClick={() => routeHandler("/dashboard/logistics")}>
                            <TruckIcon className="size-6"/>
                            <a className="ml-3">Logistica</a>
                        </li>
                        <li className="flex items-center list-none pt-3 pb-3 pl-4 pr-4 mb-3 text-gray-500 hover:text-gray-700 hover:bg-indigo-100 hover:cursor-pointer rounded-lg" onClick={() => routeHandler("/dashboard/inventory")}>
